...
exports.CaixaModule = CaixaModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_module_1.AuthModule],
        providers: [caixa_service_1.CaixaService],
        controllers: [caixa_controller_1.CaixaController],
    })
], CaixaModule);
